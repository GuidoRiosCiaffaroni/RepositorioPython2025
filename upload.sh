...
echo "git remote add origin https://github.com/GuidoRiosCiaffaroni/RepositorioPython2025.git"
#git remote add origin https://github.com/GuidoRiosCiaffaroni/RepositorioPython2025.git
